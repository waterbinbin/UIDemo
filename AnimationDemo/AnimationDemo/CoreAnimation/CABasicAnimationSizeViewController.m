//
//  CABasicAnimationSizeViewController.m
//  AnimationDemo
//
...
#import "CABasicAnimationSizeViewController.h"

@interface CABasicAnimationSizeViewController ()
...
@implementation CABasicAnimationSizeViewController
...
{
    self.title = @"CABasicAnimationSize相关动画";
}
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    if((self.count) % 3 == 0)
    {
        [self p_basicAnimationOfSize];
    }
    else if(self.count % 3 == 1)
    {
        [self p_basicAnimationOfSizeW];
    }
    else if(self.count % 3 == 2)
    {
        [self p_basicAnimationOfSizeH];
    }
    self.count++;
}
