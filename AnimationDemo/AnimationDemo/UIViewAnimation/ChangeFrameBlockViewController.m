//
//  ChangeFrameBlockViewController.m
//  AnimationDemo
//
...
#import "ChangeFrameBlockViewController.h"

@interface ChangeFrameBlockViewController ()
...
@implementation ChangeFrameBlockViewController
...
{
    self.title = @"ChangeFrame Block动画";
}
...
- (void)p_blockChangeFrameWithDelayTimeAndComplete
{
...
{
    [self p_blockChangeFrameWithDelayTimeAndComplete];
}
