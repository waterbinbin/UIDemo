//
//  CABasicAnimationCornerRadiusAndBorderViewController.m
//  AnimationDemo
//
...
#import "CABasicAnimationCornerRadiusAndBorderViewController.h"

@interface CABasicAnimationCornerRadiusAndBorderViewController ()
...
@implementation CABasicAnimationCornerRadiusAndBorderViewController
...
{
    self.title = @"CABasicAnimationCornerRadius和Border相关动画";
}
...
// cornerRadius 基本 动画
- (void)p_basicAnimationOfCornerRadius
{
...
// borderWidth 基本 动画
- (void)p_basicAnimationOfBorderWidth {
...
// borderColor 基本 动画
- (void)p_basicAnimationOfBordeColor {
...
{
    [self p_basicAnimationOfCornerRadius];
    [self p_basicAnimationOfBorderWidth];
    [self p_basicAnimationOfBordeColor];
}
