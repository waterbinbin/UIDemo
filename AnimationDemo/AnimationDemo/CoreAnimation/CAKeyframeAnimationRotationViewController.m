...
{
    self.title = @"CAKeyframeAnimationRotation相关动画";
}
...
// rotation 动画
- (void)p_rotationKeyFrameAnimation
{
    ...
    [self.signInView.layer addAnimation:ani forKey:@"RotationKeyFrameAni"];
}
...
{
    [self p_rotationKeyFrameAnimation];
}
