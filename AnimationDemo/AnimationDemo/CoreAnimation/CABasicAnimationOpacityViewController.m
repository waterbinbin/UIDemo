//
//  CABasicAnimationOpacityViewController.m
//  AnimationDemo
//
...
#import "CABasicAnimationOpacityViewController.h"

@interface CABasicAnimationOpacityViewController ()
...
@implementation CABasicAnimationOpacityViewController
...
{
    self.title = @"CABasicAnimationOpacity相关动画";
}
...
// opacity 基本 动画
- (void)p_basicAnimationOfOpacity
{
...
{
    [self p_basicAnimationOfOpacity];
}
