...
//    containerView.layer.sublayerTransform = transfrom3d;
    ...
    fromGradient.colors = @[(id)[UIColor clearColor].CGColor,
                        (id)[UIColor yellowColor].CGColor];
    fromGradient.startPoint = CGPointMake(0.0, 0.0);
    fromGradient.endPoint = CGPointMake(1.0, 0.0);
    ...
    toGradient.startPoint = CGPointMake(0.0, 0.0);
    toGradient.endPoint = CGPointMake(1, 0.0);
    UIView *toShadow = [[UIView alloc]initWithFrame:fromVC.view.bounds];
    toShadow.backgroundColor = [UIColor yellowColor];
    [toShadow.layer insertSublayer:toGradient atIndex:1];
    toShadow.alpha = 1.0;
    [toVC.view addSubview:toShadow];
    [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
        CATransform3D transfrom3d = CATransform3DIdentity;
        tempView.layer.transform = CATransform3DTranslate(transfrom3d, 375, 0, 0);//CATransform3DMakeRotation(-M_PI_2, 0, 1, 0);
        fromShadow.alpha = .0;
        toShadow.alpha = 0.0;
