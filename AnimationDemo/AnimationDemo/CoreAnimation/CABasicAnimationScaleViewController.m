...
{
    self.title = @"CABasicAnimationScale相关动画";
}
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    if((self.count) % 3 == 0)
    {
        [self p_basicAnimationOfScale];
    }
    else if(self.count % 3 == 1)
    {
        [self p_basicAnimationOfScaleX];
    }
    else if(self.count % 3 == 2)
    {
        [self p_basicAnimationOfScaleY];
    }
