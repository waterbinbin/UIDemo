...
@implementation HooyaMergeVideoAndAudio
...
+ (void)mergeVideo:(NSString *)videoPath andAudio:(NSString *)audioPath andTarget:(id)target andAction:(SEL)action
{
    ...
    NSLog(@"HooyaMergeVideoAndAudio mergeVideo outputFileType type %@",_assetExport.outputFileType);
    ...
    [_assetExport exportAsynchronouslyWithCompletionHandler:
     ^(void ) 
     {    
         NSLog(@"HooyaMergeVideoAndAudio mergeVideo finish");
