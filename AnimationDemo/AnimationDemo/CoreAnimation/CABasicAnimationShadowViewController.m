//
//  CABasicAnimationShadowViewController.m
//  AnimationDemo
//
...
#import "CABasicAnimationShadowViewController.h"

@interface CABasicAnimationShadowViewController ()
...
@implementation CABasicAnimationShadowViewController
...
{
    self.title = @"CABasicAnimationShadow相关动画";
}
...
// 需要将:_signInView.clipsToBounds = NO
// shadowColor 基本 动画
- (void)p_basicAnimationOfShadowColor
{
...
// shadowOffset 基本 动画
- (void)p_basicAnimationOfShadowoffset {
...
// shadowOpacity 基本 动画
- (void)p_basicAnimationOfShadowOpacity {
...
// shadowRadius 基本 动画
- (void)p_basicAnimationOfShadowRadius {
...
{
    [self p_basicAnimationOfShadowoffset];
    [self p_basicAnimationOfShadowColor];
    [self p_basicAnimationOfShadowOpacity];
    [self p_basicAnimationOfShadowRadius];
}
