//
//  CABasicAnimationContentsViewController.m
//  AnimationDemo
//
...
#import "CABasicAnimationContentsViewController.h"

@interface CABasicAnimationContentsViewController ()
...
@implementation CABasicAnimationContentsViewController
...
{
    self.title = @"CABasicAnimationContents相关动画";
}
...
// contents 基本 动画
- (void)p_basicAnimationOfContents
{
...
{
    [self p_basicAnimationOfContents];
}
@end
